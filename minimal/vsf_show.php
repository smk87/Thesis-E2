          ...
          //Printing values
                                            ...
                                            <form>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-8">
                                                        <input id="username" name="username" value="<?php echo $row['bill_stdid']; ?>" class="form-control here" style="font-weight: bold;"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-8">
                                                        <input id="name" name="name" value="<?php echo $row['bill_type']; ?>" class="form-control here" style="font-weight: bold;"
                                                            disabled="disabled" type="text">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-8">
                                                        <input id="text" name="dep" value="<?php echo $row['bill_info']; ?>" class="form-control here" style="font-weight: bold;"
                                                            disabled="disabled" type="text">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-8">
                                                        <input id="text" name="lvl" value="<?php echo $row['bill_amt']; ?>" class="form-control here" style="font-weight: bold;"
                                                            disabled="disabled" type="text">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-8">
                                                        <input id="text" name="term" value="<?php echo $row['bill_sts']; ?>" class="form-control here" style="font-weight: bold;"
                                                            disabled="disabled" type="text">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-8">
                                                        <input id="email" name="email" value="<?php echo $row['bill_duedate']; ?>" class="form-control here" style="font-weight: bold;"
                                                            disabled="disabled" type="text">
                                                    </div>
                                                </div>
