...
<![endif]-->
    ...
    <body class="fix-sidebar fix-header card-no-border">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <div class="col-md-6 col-8 align-self-center">
                            <h3 class="text-themecolor m-b-0 m-t-0">Mess Bills</h3>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="javascript:void(0)">Home</a>
                                </li>
                                <li class="breadcrumb-item active">Mess Bills</li>
                            </ol>
                        </div>
        ...
        //Printing values
                                        ...
                                        $q = "SELECT bill_stdid,bill_type,bill_info,bill_amt,bill_duedate,bill_id FROM bill WHERE bill_stdid='$tid' AND bill_type='Mess Bill' AND bill_sts='Not Paid'";
